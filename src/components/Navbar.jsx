...
const Navbar = () => {
  ...
  return (
    <>
      {/* --- NAVBAR UTAMA (Berada di atas dengan z-[999]) --- */}
      <nav
      ...
      {/* --- MOBILE MENU OVERLAY (Dikeluarkan dari tag <nav>, menggunakan z-[998]) --- */}
      <div
        className={`fixed inset-0 bg-white/95 backdrop-blur-xl flex flex-col items-center justify-center gap-8 transition-transform duration-300 md:hidden z-[998] ${
